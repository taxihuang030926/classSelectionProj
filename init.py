...
def time_slot_data(connectServer):
    cur = connectServer.cursor()
...
def section_data(connectServer):
    cur = connectServer.cursor()
...
def instructor_data(T_ID, connectServer):
    cur = connectServer.cursor()
...
def department_data(connectServer):
    cur = connectServer.cursor()
...
def classroom_data(connectServer):
    cur = connectServer.cursor()
